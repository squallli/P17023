...
public class FragmentVIPPayCoupon extends Fragment {
    ...
    public void initComponent(View v) {
        ...
        btnPay.setOnClickListener(v1 -> {
            ...
            // ("SC","1700000001");
//                editCuponNo.setText("1700000001");
//                spinnerType.setSelection(0);

            // ("DC","0012AA");
//                editCuponNo.setText("0012AA");
//                spinnerType.setSelection(1);
            ...
            VipPayActivity.imm.hideSoftInputFromWindow(editCuponNo.getWindowToken(), 0);
