...
import tw.com.regalscan.app.converterfactory.FastJsonConverterFactory;
...
//    public static String sDomain = Api.APP_DOMAIN;
    ...
    public void applyOptions(Context context, GlobalConfigModule.Builder builder) {
        ...
        builder.baseurl(Constant.API_TEST)
...
//                    okhttpBuilder.sslSocketFactory(); //支持 Https,详情请百度
    ...
    @Override
    public void injectActivityLifecycle(Context context, List<ActivityLifecycleCallbacks> lifecycles) {
